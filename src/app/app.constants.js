export default {
  EVENTS: {
    ...
    SET_SELECTED_CHAPTER_REDUX: 'SET_SELECTED_CHAPTER_REDUX',

    // SCANS
    CLEAR_SCANS_REDUCER: 'CLEAR_SCANS_REDUCER',
    GET_SCANS_SAGA: 'GET_SCANS_SAGA',
    SET_SCANS_REDUX: 'SET_SCANS_REDUX',
    UPDATE_SCAN_INFOS_SAGA: 'UPDATE_SCAN_INFOS_SAGA',
    UPDATE_SCAN_INFOS_REDUX: 'UPDATE_SCAN_INFOS_REDUX',
    SET_PAGE_COUNTER_REDUX: 'SET_PAGE_COUNTER_REDUX',
  },
  FIRESTORE: {
